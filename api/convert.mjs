...
<head>
    ...
    <title>SonicGrab | High-Quality YouTube to M4A Converter</title>
...
<body class="bg-slate-950 text-slate-200 min-h-screen">
    ...
    <main class="max-w-4xl mx-auto px-6 pb-20">
        <section class="glass p-8 md:p-12 rounded-[2rem] border border-slate-800 shadow-2xl mb-16">
            <h1 class="text-3xl md:text-5xl font-extrabold text-white mb-4">YouTube to M4A Converter</h1>
            <p class="text-slate-400 mb-3">Convert YouTube videos to high-quality M4A files instantly. No registration, no intrusive ads.</p>
            
            <!-- Video Length Notice -->
            <p class="text-xs text-amber-400/90 font-medium mb-8 flex items-center gap-1.5 bg-amber-500/10 border border-amber-500/20 w-fit px-3 py-1.5 rounded-full">
                <span>💡</span> Note: Only videos up to 20 minutes are supported for fast processing.
            </p>
                ...
                <div id="successCard" class="hidden bg-slate-900/80 border border-emerald-500/20 p-6 rounded-2xl flex flex-col gap-4">
                    <div class="flex items-start gap-4">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <p class="text-xs text-slate-400 mt-0.5">High Fidelity Audio</p>
                        </div>
                    </div>
        ...
        <section class="space-y-12">
            <div>
                ...
                <p class="leading-relaxed text-slate-400">SonicGrab provides one of the fastest ways to convert videos to high-fidelity audio. Our systems are optimized to deliver your files instantly.</p>
            </div>
        </section>
    </main>
    <footer class="text-center p-8 text-slate-600 text-sm border-t border-slate-900">
        <p>&copy; 2026 SonicGrab. By using this service, you agree to our terms of use.</p>
    </footer>
    <script>
        const API_BASE = '/api'; 
        ...
        convertBtn.addEventListener('click', async () => {
            ...
            try {
                ...
                if (response.status === 504) {
                    throw new Error("This video is too long to convert. Only videos under 20 minutes are supported.");
                }
                ...
                try {
                    ...
                    throw new Error("Conversion timed out. Please try a shorter video (under 20 minutes).");
                }
    ...
    <script async data-explicit-opt-in="true" data-cookie-opt-in="true" data-deployment-id="dpl_5M2212zhBSs5ZoR9sBaZvEjN6VwH" src="https://vercel.live/_next-live/feedback/feedback.js"></script>
    <script async data-explicit-opt-in="true" data-cookie-opt-in="true" data-deployment-id="dpl_BHyv5qpmL3Q1RoC2qSJWTmSMHjeJ" src="https://vercel.live/_next-live/feedback/feedback.js"></script>
</body>
</html>
